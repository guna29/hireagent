...
from hireagent.config import COVER_LETTER_DIR, RESUME_PATH, load_profile
from hireagent.database import get_connection, get_jobs_by_stage
from hireagent.llm import get_cover_client
...
def _strip_preamble(text: str) -> str:
    ...
    Some models sometimes output "Here is the cover letter:" or
...
def run_cover_letters(min_score: int = 7, limit: int = 20,
    ...
    for job in jobs:
        ...
        try:
            ...
            pdf_path = None
            try:
                from hireagent.scoring.pdf import convert_to_pdf
